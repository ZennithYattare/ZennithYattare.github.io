...
<html lang="en">
	...
	<body class="bgcolor">
			...
			<div class="container">
				...
				<p>
					 ...
					 <script type="text/javascript"> 
						...
						document.write("Followers | " + random ); 
					</script>					 
					</a>
					<a class="btn btn-secondary my-2">
					<script type="text/javascript"> 
						...
						var max=4000; 
						var random = Math.floor(Math.random() * (+max + 1 - +min)) + +min; 
						document.write("Following | " + random ); 
					</script>	
					</a>
				...
				<div class="card-columns">
					<div class="card bg-secondary">
						<div class="card-header bg-info">
							<div class="mr-2" style="height: 20px; width: 20px; background-color: #F60; vertical-align: middle; border-radius: 50%; display: inline-block;"></div>
								<script type="text/javascript">
						...
						<div class="card-body">
							...
							<script type="text/javascript"> 
								...
								var max=58; 
								var random = Math.floor(Math.random() * (+max + 1 - +min)) + +min; 
								document.write("Posted " + random + " minutes ago" ); 
							</script>
							</small> </p>
					...
					<div class="card bg-secondary">
						<div class="card-header">
							<div class="mr-2" style="height: 20px; width: 20px; background-color: #176BEF; vertical-align: middle; border-radius: 50%; display: inline-block;"></div>
								<script type="text/javascript">
								var chars = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXTZabcdefghiklmnopqrstuvwxyz";
								var string_length = 2;
								var randomstring = '';
					...
					<div class="card bg-secondary">
						<div class="card-header">
							<div class="mr-2" style="height: 20px; width: 20px; background-color: #CCFFE5; vertical-align: middle; border-radius: 50%; display: inline-block;"></div>
								<script type="text/javascript">
								var chars = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXTZabcdefghiklmnopqrstuvwxyz";
								var string_length = 2;
								var randomstring = '';
						...
						<div class="card-body">
							...
							<p> <small>							<script type="text/javascript"> 
								...
								var max=58; 
								var random = Math.floor(Math.random() * (+max + 1 - +min)) + +min; 
								document.write("Updated " + random + " minutes ago" ); 
							</script></small> </p>
							<div class="d-flex justify-content-between align-items-center">
								<div class="btn-group">
									<button type="button" class="btn btn-sm btn-outline-secondary">Like</button>
					...
					<div class="card bg-secondary">
						<div class="card-header bg-success">
							<div class="mr-2" style="height: 20px; width: 20px; background-color: #E633FF; vertical-align: middle; border-radius: 50%; display: inline-block;"></div>
								<script type="text/javascript">
								var chars = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXTZabcdefghiklmnopqrstuvwxyz";
								var string_length = 2;
								var randomstring = '';
						...
						<p> <small>							<script type="text/javascript"> 
								...
								var max=23; 
								var random = Math.floor(Math.random() * (+max + 1 - +min)) + +min; 
								document.write("Posted " + random + " hours ago" ); 
							</script></small> </p>
						<div class="d-flex justify-content-between align-items-center">
							<div class="btn-group">
								<button type="button" class="btn btn-sm btn-outline-secondary">Like</button>
					...
					<div class="card bg-secondary">
						<div class="card-header bg-danger">
							<div class="mr-2" style="height: 20px; width: 20px; background-color: #8B8BFF; vertical-align: middle; border-radius: 50%; display: inline-block;"></div>
								<script type="text/javascript">
								var chars = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXTZabcdefghiklmnopqrstuvwxyz";
								var string_length = 2;
								var randomstring = '';
						...
						<div class="card-body text-center">
							...
							<p style="text-align: left;"> <small>							<script type="text/javascript"> 
								var min=1; 
								var max=58; 
								var random = Math.floor(Math.random() * (+max + 1 - +min)) + +min; 
								document.write("Last updated " + random + " minutes ago" ); 
							</script></small> </p>
							<div class="d-flex justify-content-between align-items-center">
								<div class="btn-group">
									<button type="button" class="btn btn-sm btn-outline-secondary">Like</button>
					...
					<div class="card bg-secondary">
						<div class="card-header">
							<div class="mr-2" style="height: 20px; width: 20px; background-color: #FFF226; vertical-align: middle; border-radius: 50%; display: inline-block;"></div>
								<script type="text/javascript">
								var chars = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXTZabcdefghiklmnopqrstuvwxyz";
								var string_length = 2;
								var randomstring = '';
						...
						<div class="card-body">
							...
							<p> <small>							<script type="text/javascript"> 
								...
								var max=23; 
								var random = Math.floor(Math.random() * (+max + 1 - +min)) + +min; 
								document.write("Updated " + random + " hours ago" ); 
							</script></small> </p>
							<div class="d-flex justify-content-between align-items-center">
								<div class="btn-group">
									<button type="button" class="btn btn-sm btn-outline-secondary">Like</button>
					...
					<div class="card bg-secondary">
						<div class="card-header">
							<div class="mr-2" style="height: 20px; width: 20px; background-color: #FF6666; vertical-align: middle; border-radius: 50%; display: inline-block;"></div>				
								<script type="text/javascript">
								var chars = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXTZabcdefghiklmnopqrstuvwxyz";
								var string_length = 2;
								var randomstring = '';
		...
		<footer class="text-muted">
			<div class="container">
				<p class="float-right">
					<a href="clickmedia.jsp">Back to top</a>
				</p>
